 ...
 */
export function compute_visibility_polygons(sources: Float32Array, obstacles: Float32Array): any;
...
export interface InitOutput {
    ...
    readonly renderengine_get_light_obstacle_segments_flat: (a: number) => any;
    readonly renderengine_get_obstacle_segments_flat: (a: number) => any;
