...
export interface InitOutput {
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h642cd14eabb614b4: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h37ec37fce59d16cc: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h77a134a8105407ab: (a: number, b: number) => void;
