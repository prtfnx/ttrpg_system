...
export class RenderEngine {
    free(): void;
    [Symbol.dispose](): void;
    add_fog_polygon(id: string, polygon: any): void;
     ...
     */
    add_light_for_table(id: string, x: number, y: number, table_id: string): void;
     ...
     */
    capture_active_table_thumbnail(table_id: string, requested_width: number, requested_height: number): Uint8Array;
    clear_fog(): void;
    ...
    clear_walls(): void;
    compute_light_visibility_polygons(sources: Float32Array): any;
    compute_sight_visibility_polygons(sources: Float32Array): any;
     ...
     */
    translate_selected_walls(dx: number, dy: number): Array<any>;
 ...
 */
export function calculate_asset_hash(data: Uint8Array): string;
...
export interface InitOutput {
    ...
    readonly renderengine_add_light_for_table: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
    ...
    readonly renderengine_clear_vision_polygons: (a: number) => void;
    readonly renderengine_clear_walls: (a: number) => void;
    readonly renderengine_compute_light_visibility_polygons: (a: number, b: any) => any;
    readonly renderengine_compute_sight_visibility_polygons: (a: number, b: any) => any;
    ...
    readonly renderengine_get_occlusion_revision: (a: number) => number;
    ...
    readonly renderengine_paint_can_redo: (a: number) => number;
    ...
    readonly renderengine_paint_redo_stroke: (a: number) => number;
    ...
    readonly renderengine_set_light_enabled: (a: number, b: number, c: number, d: number) => void;
    ...
    readonly renderengine_get_selected_walls: (a: number) => [number, number];
    ...
    readonly renderengine_remove_selected_walls: (a: number) => [number, number];
    ...
    readonly renderengine_unload_texture: (a: number, b: number, c: number) => number;
    ...
    readonly renderengine_capture_active_table_thumbnail: (a: number, b: number, c: number, d: number, e: number) => [number, number, number, number];
    ...
    readonly renderengine_clear_runtime_event_handler: (a: number) => void;
    readonly renderengine_clear_runtime_operation_handler: (a: number) => void;
    readonly renderengine_get_render_diagnostics: (a: number) => [number, number, number];
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h346c1d2cbe4d6714: (a: number, b: number) => void;
