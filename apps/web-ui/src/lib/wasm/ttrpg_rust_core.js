...
export class BrushPreset {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        BrushPresetFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_brushpreset_free(ptr, 0);
    }
    /**
     * @param {PaintSystem} paint_system
     */
    apply_to_paint_system(paint_system) {
        _assertClass(paint_system, PaintSystem);
        wasm.brushpreset_apply_to_paint_system(this.__wbg_ptr, paint_system.__wbg_ptr);
    }
    /**
     * @param {number} r
     * @param {number} g
     ...
     */
    constructor(r, g, b, a, width, blend_mode) {
        const ptr0 = passStringToWasm0(blend_mode, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.brushpreset_new(r, g, b, a, width, ptr0, len0);
        this.__wbg_ptr = ret >>> 0;
        BrushPresetFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
if (Symbol.dispose) BrushPreset.prototype[Symbol.dispose] = BrushPreset.prototype.free;
...
export class RenderEngine {
     ...
     * @returns {string | undefined}
     */
    get_light_at_position(x, y) {
        const ret = wasm.renderengine_get_light_at_position(this.__wbg_ptr, x, y);
        let v1;
        if (ret[0] !== 0) {
            v1 = getStringFromWasm0(ret[0], ret[1]).slice();
            wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
     ...
     * @returns {any}
     */
    get_sprite_data(sprite_id) {
        const ptr0 = passStringToWasm0(sprite_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.renderengine_get_sprite_data(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
     ...
     * @returns {string | undefined}
     */
    handle_mouse_down_with_modifiers(screen_x, screen_y, ctrl_key, shift_key) {
        const ret = wasm.renderengine_handle_mouse_down_with_modifiers(this.__wbg_ptr, screen_x, screen_y, ctrl_key, shift_key);
        let v1;
        if (ret[0] !== 0) {
            v1 = getStringFromWasm0(ret[0], ret[1]).slice();
            wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
    ...
    request_table(table_name) {
        const ptr0 = passStringToWasm0(table_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.renderengine_request_table(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    send_sprite_create(sprite_data_js) {
        const ret = wasm.renderengine_send_sprite_create(this.__wbg_ptr, sprite_data_js);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    send_sprite_move(sprite_id, x, y) {
        ...
        try {
            const ptr0 = passStringToWasm0(sprite_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.renderengine_send_sprite_move(this.__wbg_ptr, ptr0, len0, x, y);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
    ...
    set_layer_visible(layer_name, visible) {
        const ptr0 = passStringToWasm0(layer_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.renderengine_set_layer_visible(this.__wbg_ptr, ptr0, len0, visible);
        return ret !== 0;
    }
    /**
     * @param {string} id
     ...
     * @returns {boolean}
     */
    set_sprite_position(sprite_id, x, y) {
        const ptr0 = passStringToWasm0(sprite_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.renderengine_set_sprite_position(this.__wbg_ptr, ptr0, len0, x, y);
        return ret !== 0;
    }
    /**
     ...
     * @returns {boolean}
     */
    set_sprite_scale(sprite_id, scale_x, scale_y) {
        const ptr0 = passStringToWasm0(sprite_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.renderengine_set_sprite_scale(this.__wbg_ptr, ptr0, len0, scale_x, scale_y);
        return ret !== 0;
    }
    /**
...
export class UnitConverter {
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        UnitConverterFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_unitconverter_free(ptr, 0);
    }
}
if (Symbol.dispose) UnitConverter.prototype[Symbol.dispose] = UnitConverter.prototype.free;
...
export function request_animation_frame(callback) {
    const ret = wasm.request_animation_frame(callback);
    return ret;
}
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_new_with_event_init_dict_1be66f4b677892bd: function() { return handleError(function (arg0, arg1, arg2) {
        ...
        __wbg_set_detail_a84990ecfb401e5d: function(arg0, arg1) {
            arg0.detail = arg1;
        },
        ...
        __wbindgen_cast_0000000000000002: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("CloseEvent")], shim_idx: 82, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h5741d4f52263a6d5);
            return ret;
        },
        __wbindgen_cast_0000000000000003: function(arg0, arg1) {
            // Cast intrinsic for `Closure(Closure { owned: true, function: Function { arguments: [NamedExternref("ErrorEvent")], shim_idx: 82, ret: Unit, inner_ret: Some(Unit) }, mutable: true }) -> Externref`.
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h5741d4f52263a6d5_2);
            return ret;
        },
        __wbindgen_cast_0000000000000004: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h5741d4f52263a6d5_3);
            return ret;
        },
        __wbindgen_cast_0000000000000005: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h5741d4f52263a6d5_4);
            return ret;
        },
        __wbindgen_cast_0000000000000006: function(arg0, arg1) {
            ...
            const ret = makeMutClosure(arg0, arg1, wasm_bindgen__convert__closures_____invoke__h924d0917b2d9b9ed);
            return ret;
        },
...
function wasm_bindgen__convert__closures_____invoke__h924d0917b2d9b9ed(arg0, arg1) {
    wasm.wasm_bindgen__convert__closures_____invoke__h924d0917b2d9b9ed(arg0, arg1);
}

function wasm_bindgen__convert__closures_____invoke__h5741d4f52263a6d5(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h5741d4f52263a6d5(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__h5741d4f52263a6d5_2(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h5741d4f52263a6d5_2(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__h5741d4f52263a6d5_3(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h5741d4f52263a6d5_3(arg0, arg1, arg2);
}

function wasm_bindgen__convert__closures_____invoke__h5741d4f52263a6d5_4(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__h5741d4f52263a6d5_4(arg0, arg1, arg2);
}
...
const BrushPresetFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_brushpreset_free(ptr >>> 0, 1));
...
const UnitConverterFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_unitconverter_free(ptr >>> 0, 1));
