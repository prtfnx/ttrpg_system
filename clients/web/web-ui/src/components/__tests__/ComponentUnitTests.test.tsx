...
vi.mock('../../store', () => ({
  useGameStore: vi.fn().mockReturnValue({
    ...
    // Add stubs for all GameStore methods to avoid destructuring errors
    getSpritesForCharacter: vi.fn(),
    getCharacterForSprite: vi.fn(),
    canControlSprite: vi.fn(),
    canEditCharacter: vi.fn(),
    linkSpriteToCharacter: vi.fn(),
    unlinkSpriteFromCharacter: vi.fn(),
    tables: [],
    tablesLoading: false,
    setTables: vi.fn(),
