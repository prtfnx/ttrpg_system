...
try:
    ...
    logging.warning(f"Could not import bestiary module: {e}")
    BestiaryLoader = None
...
try:
    ...
    logging.warning(f"Could not import spell module: {e}")
    SpellLoader = None
...
try:
    ...
    logging.warning(f"Could not import character module: {e}")
...
try:
    ...
    logging.warning(f"Could not import equipment module: {e}")
