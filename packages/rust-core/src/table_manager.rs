...
impl TableManager {
    ...
    pub fn zoom_table(
        ...
        let center_table_coords =
            if let Some(coords) = self.screen_to_table(table_id, center_x, center_y) {
                coords
            } else {
                return false;
            };
    ...
    pub fn units_to_pixels(&self, table_id: &str, game_distance: f64) -> f64 {
        self.get_unit_converter(table_id)
            .to_pixels(game_distance as f32) as f64
    }
